...
const qwzd: IProject = {
  ...
  desc: 'React를 사용한 프로젝트로 백엔드와 협업하여 클라이언트 부분 100%를 개발했습니다. 구단주 검색으로 해당 구단주의 경기 별 스탯과 선수 랭킹을 확인하는 서비스입니다. 프로젝트 환경 설정부터 디자인, 개발, 배포까지의 전반적인 과정을 학습했습니다. 70%의 모바일 사용자의 만족을 위해 반응형 작업을 진행했습니다. 5개월 기간동안 DAU 200에서 1000을 유지하는 서비스로 발전시켰습니다. 기존에 JavaScript로 진행한 프로젝트를 TypeScript로 마이그레이션을 진행했습니다. 정적 타입 지원을 통해 컴파일 단계에서 오류를 잡을 수 있게 하고 팀원을 추가하는 과정에서 코드를 예측할 수 있게 했습니다. Redux Toolkit을 도입해 기존의 상태들을 전역으로 관리했습니다. 각 컴포넌트에서 구독해 기존의 props drilling을 개선했습니다.',
  duration: '2021.9 ~',
